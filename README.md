# Selefra Provider Gandi

Use this repo as a raw reference to **tables and schema** for Gandi resources. [Here's](https://github.com/selefra/selefra-provider-gandi/blob/main/docs/tables/gandi.md) a summary of full coverage.
